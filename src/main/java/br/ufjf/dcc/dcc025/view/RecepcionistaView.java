...
public class RecepcionistaView extends JFrame {
    ...
    private void verificarFaltas() {
        ...
        btnMarcarFalta.addActionListener(ev -> {
            ...
            if (row == -1) {
                javax.swing.JOptionPane.showMessageDialog(this, "Selecione uma consulta para marcar falta.");
                return;
            }
            ...
            int confirm = javax.swing.JOptionPane.showConfirmDialog(this, "Confirmar marcação de falta para " + paciente.getNome().getNome() + " " + paciente.getNome().getSobrenome() + "?", "Confirmar", javax.swing.JOptionPane.YES_NO_OPTION);
            ...
            for (br.ufjf.dcc.dcc025.model.Medico m : medicos) {
                if (m.getNome().toString().equals(nomeMedico) || m.getNome().getSobrenome().equals(nomeMedico)) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Falta marcada e médico notificado.");
            ((javax.swing.JDialog) javax.swing.SwingUtilities.getWindowAncestor(this)).dispose();
        });

        javax.swing.JDialog dialog = new javax.swing.JDialog(this, "Verificar faltas", true);
    ...
    // Expor listener para verificar faltas (controller controla a lógica)
    public void addConsultarFaltasListener(java.awt.event.ActionListener listener) {
        btnConsultarFaltas.addActionListener(listener);
    }
